...
public class Jogo
{
    ...
    private static int quantThreadsCM; // Armazena o resultado do cálculo da quantidade de elementos dos arrays de Threads de Colisão e Movimentação
    private static int quantThreadsL; // Armazena o resultado do cálculo da quantidade de elementos do array de Threads para Lidar com as Colisões
    ...
    public static void Rodar()
    {
        ...
        while (true)
        {
            ...
            /* Lógica da otimização (Colisão): Focar a colisão entre os carros mais próximos, ou seja
            ...
            /* Lógica da otimização (Movimentação): Movimentar em cada thread 2 carros ao mesmo tempo
            ...
            // Inicie as threads para verificar colisão / executar movimento entre os carros
    ...
    private static void ConfigurarCorrida()
    {
        ...
        quantThreadsCM = 3 * (carros.Length / 6); // Definindo a quantidade de elementos dos arrays das Threads de colisão e movimentação
        quantThreadsL = 2 * (carros.Length / 6); // Definindo a quantidade de elementos do array das Threads de Lidar com as colisões
